    ...
    return (
        <section className="bg-white rounded m-2 p-2 lg:m-4 xl:m-8">
            ...
            <p className="text-center text-base lg:text-xl m-auto max-w-[90%] lg:max-w-[50%] p-2 indent-5">
                ...
                My resume can be downloaded <a className="underline text-blue-600 hover:text-blue-950" href="./src/assets/Resume-Chase-Seeberger.pdf" target="_blank" rel="noopener noreferrer">here</a> as a PDF.
